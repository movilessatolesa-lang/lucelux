...
-- Añadir columnas SaaS al perfil
...
-- ============================================================
-- TABLA: suscripciones
-- Cada usuario tiene una fila con su plan y estado de trial.
-- ============================================================
...
-- Superadmin puede ver todas las suscripciones
...
-- ============================================================
-- TABLA: equipos
-- Cada empresa puede tener un equipo (plan business).
-- El owner es el usuario que paga.
-- ============================================================
...
-- Usuarios que han sido invitados al equipo de otra empresa.
-- ============================================================
...
-- ============================================================
-- Trigger: al registrar usuario → crear trial automáticamente
-- Extiende el trigger on_auth_user_created existente
-- ============================================================
create or replace function public.handle_new_user()
returns trigger language plpgsql security definer set search_path = public
as $$
...
-- El trigger ya existe, el replace de la función es suficiente

-- Trigger para modificado_en en suscripciones
